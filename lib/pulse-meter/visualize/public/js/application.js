...
(function() {
  ...
  document.startApp = function() {
    ...
    DynamicChartView = Backbone.View.extend({
      ...
      increaseTimespan: function(inc) {
        return this.widget.increaseTimespan(inc);
      },
      resetTimespan: function() {
        return this.widget.resetTimespan();
      },
    ...
    DynamicWidgetView = Backbone.View.extend({
      ...
      extendTimespan: function() {
        var select, val;
        select = this.$el.find("#sensor-controls #extend-timespan-val");
        val = select.first().val();
        this.chartView.increaseTimespan(parseInt(val));
        return this.refreshChart();
      },
      resetTimespan: function() {
        this.chartView.resetTimespan();
        return this.refreshChart();
      },
      template: function() {
