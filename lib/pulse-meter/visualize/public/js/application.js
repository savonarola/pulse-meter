...
document.startApp = function() {
  var AppRouter, AreaPresenter, DynamicChartView, DynamicWidgetView, GaugePresenter, LinePresenter, PiePresenter, SensorInfoListView, SeriesPresenter, TablePresenter, TimelinePresenter, WidgetChartView, WidgetListView, WidgetPresenter, WidgetView, appRouter, pageInfos, pageTitlesApp, widgetList, widgetListApp;
  ...
  DynamicChartView = Backbone.View.extend({
    ...
    redrawChart: function() {
      if (this.presenter) {
        ...
        return this.presenter = WidgetPresenter.create(pageInfos, this.widget, this.chartContainer());
      }
    },
  ...
  WidgetChartView = Backbone.View.extend({
    ...
    render: function() {
      return this.presenter = WidgetPresenter.create(pageInfos, this.model, this.el);
    }
  });
