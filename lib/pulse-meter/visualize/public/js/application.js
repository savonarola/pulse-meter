...
(function() {
  ...
  document.startApp = function() {
    ...
    DynamicWidget = Backbone.Model.extend({
      ...
      increaseTimespan: function(inc) {
        return this.timespanInc = this.timespanInc + inc;
      },
      resetTimespan: function() {
        return this.timespanInc = 0;
      },
      ...
      url: function() {
        ...
        timespan = this.timespan();
        if (!_.isNaN(timespan)) url = "" + url + "&timespan=" + timespan;
        return url;
      },
      forceUpdate: function() {
        return this.fetch({
    ...
    DynamicChartView = Backbone.View.extend({
      initialize: function() {
        ...
        return this.widget.bind('redraw', this.updateChart, this);
      },
      tagName: 'div',
      ...
      error: function(error) {
        return this.$el.append(this.errorTemplate()({
          error: error
        }));
      },
      render: function() {
      ...
      intervalsEqual: function(sensors) {
        ...
        interval = this.sensors[0].get('interval');
        badIntervals = _.filter(this.sensors, function(s) {
      ...
      updateChart: function() {
        console.log(this.$el.find('#chart').first());
        console.log(this.widget);
        return this.presenter = WidgetPresenter.create(this.widget, this.$el.find('#chart')[0]);
      },
      draw: function(sensors, type) {
        this.sensors = sensors;
        this.type = type;
        if (!this.intervalsEqual()) {
    ...
    DynamicWidgetView = Backbone.View.extend({
      ...
      initialize: function() {
        ...
        return this.chartView = new DynamicChartView;
      },
      events: {
      ...
      render: function(container) {
        ...
        this.$el.find('#dynamic-plotarea').append(this.chartView.el);
        return this.sensorInfo.fetch();
      }
    });
