  ...
  document.startApp = function() {
    ...
    SensorInfoListView = Backbone.View.extend({
      ...
      initialize: function(args) {
        console.log(args);
        this.sensorInfo = args.sensorInfo;
        return this.sensorInfo.bind('reset', this.render, this);
      },
      render: function() {
        console.log(this.sensorInfo.toJSON());
    ...
    DynamicWidgetView = Backbone.View.extend({
      initialize: function() {
        return this.sensorInfo = new SensorInfoList;
      },
      template: function() {
      ...
      render: function() {
        ...
        this.sensorListView = new SensorInfoListView({
          sensorInfo: this.sensorInfo
        });
        container.find('#sensor-list-area').append(this.sensorListView.el);
