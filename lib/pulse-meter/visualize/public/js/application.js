...
(function() {
  ...
  $(function() {
    var AppRouter, PageTitle, PageTitleList, PageTitleView, PageTitlesView, Widget, WidgetChartView, WidgetList, WidgetListView, WidgetView, appRouter, pageTitles, pageTitlesApp, widgetList, widgetListApp;
    ...
    Widget = Backbone.Model.extend({
      ...
      refetch: function() {
        if (this.time() > this.nextFetch) {
          this.fetch();
          return this.setNextFetch();
        }
      },
      cutoffValue: function(value, min, max) {
        var newValue;
        newValue = value;
      ...
      cutoff: function(min, max) {
        return _.each(this.get('series'), function(s) {
          return _.each(s.data, function(v) {
            return v.y = this.cutoffValue(v.y, min, max);
          }, this);
        }, this);
      }
    });
    ...
    WidgetView = Backbone.View.extend({
      ...
      initialize: function() {
        ...
        return this.model.bind('change', this.renderChart, this);
      },
      events: {
      ...
      renderChart: function() {
        this.model.cutoff(this.cutoffMin(), this.cutoffMax());
